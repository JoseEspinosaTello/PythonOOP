#we will store vlaues on csv file
# this allows the data to be saved in a table structured file.

# static methods: will exicute code with logical connection to a class.
# A static method is a method which is bound to the class and not the object of the class.
# It can’t access or modify class state. It is present in a class because it makes sense for the method to be present in class.
